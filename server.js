...
io.on("connection", (socket) => {
  ...
  // createRoom  (YENİ: channelType parametresi eklendi)
  ...
  socket.on('textMessage', async ({ channelId, content }) => {
    try {
      ...
      // Tüm o kanaldaki kullanıcılara yay
      ...
      socket.emit('errorMessage', "Mesaj gönderilirken hata oluştu.");
    }
  });
